...
export const createCart = async (ID: string): Promise<ClientResponse<Cart>> => {
...
export const addLineItemsToCart = async (cartId: string, arrayOfSKUs: Array<string>): Promise<ClientResponse<Cart>> => {
